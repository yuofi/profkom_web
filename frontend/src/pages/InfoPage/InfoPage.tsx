...
import {
  ContactDirectory,
  type FilterCriteria,
} from "../../components/ContactDirectory/ContactPage";
import {
  ContactChip,
  type ContactInfo,
} from "../../components/ContactChip/ContactChip";
...
export const InfoPage = () => {
  ...
  if (isError)
    return (
      <div className={styles.container}>Ошибка при загрузке контактов.</div>
    );
      ...
      <article className={styles.mainContent}>
        ...
        <div className={styles.chipList}>
          {filteredContacts
            ...
            .map((contact) => {
              const initialContent = stringifyContent(
                mapContactToInfo(contact),
              );
